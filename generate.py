...
class CrosswordCreator():
    ...
    # check if supported by any word in y
           supported = False
    ...
    def consistent(self, assignment):
        # ensure krta h 2 variables ki domain main same values na ho
        for var1 in assignment:
            for var2 in assignment:
                if var1==var2 : continue
                if assignment[var1]== assignment[var2]:
                        return False
        # Ensure krta h length theek h 
        ...
        # Sirf tab check karna hai jab neighbor bhi assigned ho
    ...
    def order_domain_values(self, var, assignment):
        ...
        for value in self.domains[var]: 
            ...
            # sort by count (second item in tuple)
        pq.sort(key=lambda x: x[1])

# return only the values, in sorted order
        return [value for value, count in pq]
    ...
    def select_unassigned_variable(self, assignment):
        ...
        # If only one variable has the smallest domain, return it
        if len(mrv_vars) == 1:
            return mrv_vars[0]
        ...
        for var in mrv_vars:
            ...
            if degree > max_degree:
                ...
                degree_vars.append(var)

        # Return any of the tied highest-degree variables
